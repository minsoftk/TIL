...
# 출력
print('a - a[\'name\']', a['name'])  # 존재X -> 에러 발생
print('a - a.get(\'name\') ', a.get('name'))  # 존재X -> None 처리
print('b - b[0]', b[0])
print('b - b.get(0)', b.get(0))
print('c - c[\'arr\']', c['arr'])
print('c - c[\'arr\'][3]', c['arr'][3])
print('c - c.get(\'arr\')', c.get('arr'))
...
print('l - s1 | s2  ', s1 | s2)
print('l - union', s1.union(s2))

print('l - s1 - s2', s1 - s2)
print('l - difference', s1.difference(s2))
